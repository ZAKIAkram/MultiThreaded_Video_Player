...
int main(int argc, char *argv[]) {
  ...
  // each in a thread
  pthread_create(&theora_thread, NULL, theoraStreamReader, (void*)argv[1]);
  pthread_create(&vorbis_thread, NULL, vorbisStreamReader, (void*)argv[1]);
  ...
  pthread_cancel(Affichage_thread);
